Shader "MyCustom/_Grass"
{
    Properties
    {
        ...
        _Width              ("_Width",              Range(0, 0.1))  = 0.02
        _WidthRandom        ("_WidthRandom",        Range(0, 0.1))  = 0.05
    ...
    void geo(triangle v2g IN[3], inout TriangleStream<g2f> triStream)
    {
        ...
        float width = _Width + _randomValue(pos.yxz) * _WidthRandom;
        ...
        height = max(height - radius * 1, 0.1);
